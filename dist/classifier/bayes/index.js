...
Naivebayes.prototype.learn = function (text, category) {
  ...
  Object.keys(frequencyTable).forEach(function (token) {
    ...
    if (!self.wordFrequencyCount[category][token]) self.wordFrequencyCount[category][token] = frequencyInText;else self.wordFrequencyCount[category][token] += frequencyInText;
...
Naivebayes.prototype.categorize = function (text) {
  ...
  probabilities.forEach(function (categoryProbability) {
...
Naivebayes.prototype.probabilities = function (text) {
  ...
  return Object.keys(self.categories).map(function (category) {
...
Naivebayes.prototype.frequencyTable = function (tokens) {
  ...
  tokens.forEach(function (token) {
    if (!frequencyTable[token]) frequencyTable[token] = 1;else frequencyTable[token]++;
  });
